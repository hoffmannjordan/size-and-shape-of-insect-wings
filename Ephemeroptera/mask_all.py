...
if __name__=='__main__':
	file_list_seg = ["./Chirotonetes_albomanicatus_fig222_0_FMM_seg2.csv"]
	for filetodo in file_list_seg:
		...
		grayscale_data_scan = import_data('./Chirotonetes_albomanicatus_fig222_0.png',0.25)
		...
		np.savetxt('./Chirotonetes_albomanicatus_fig222_0_masked.csv', new_file.astype(int), fmt='%i', delimiter=',')
		#os.remove(filetodo)