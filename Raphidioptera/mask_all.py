...
if __name__=='__main__':
	file_list_seg = ["./Raphidia adnixa_fig168_2_FMM_seg2.csv"]
	for filetodo in file_list_seg:
		...
		grayscale_data_scan = import_data('./Raphidia adnixa_fig168_2.png',0.25)
		...
		np.savetxt('./Raphidia adnixa_fig168_2_masked.csv', new_file.astype(int), fmt='%i', delimiter=',')
		#os.remove(filetodo)